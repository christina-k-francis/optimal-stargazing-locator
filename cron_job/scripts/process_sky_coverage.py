...
def main():
    ...
    create_nws_gif(ds, "bone", "Percentage of Sky Covered by Clouds", "Cloud Coverage")
    log_memory_usage("After creating sky cover gif")
    generate_tiles_from_zarr(ds, "cloud_coverage", "data-layer-tiles/SkyCover_Tiles", 0.005, "bone")
