...
def get_wind_speed_direction():
    ...
    print("Downloading Latest NWS NDFD Wind Speed data...")
    ...
    print("Downloading Latest NWS NDFD Wind Direction data...")   
    ...
    print('Merging Wind Speed and Wind Direction datasets...')
    ...
    print("Saving Resultant Dataset to Cloud...")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        speed_ds.to_zarr(zarr_path, mode="w")
    ...
    print('Latest 6-hourly 7-Day Forecast of Wind Speed and Direction Saved!')
    return speed_ds
